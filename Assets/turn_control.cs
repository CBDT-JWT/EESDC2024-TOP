...
public class TurnControl : MonoBehaviour
{
    ...
    public static int JustScored = 0;//分别取值为RED,BLUE,表示红方进球、蓝方进球。
    ...
    if(Status == None&&JustScored!=None){//进球且已经执行了trigger_left.cs或trigger_right.cs中的代码且尚未交替球权
        Status = -JustScored;//交替球权
        JustScored = None;//重置just_scored
    }
}
}
